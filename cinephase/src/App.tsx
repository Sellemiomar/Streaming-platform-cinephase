...
const GITHUB_LINK = "https://github.com/Sellemiomar/Streaming-platform-cinephase";
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 lg:gap-8 text-xs font-mono">
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer" 
              className="bg-zinc-900 border border-zinc-800 hover:border-sky-450 text-zinc-300 hover:text-white px-3 py-2 rounded flex items-center gap-1.5 transition-all group"
            >
              <Cpu className="w-3.5 h-3.5 text-sky-400 group-hover:scale-110 transition-transform" />
              <span id="github-repo-link-text" className="font-bold tracking-wider text-[10.5px] text-zinc-300 group-hover:text-sky-400 transition-colors">DÉPÔT GITHUB SOURCE</span>
              <ExternalLink className="w-3 h-3 text-zinc-500 group-hover:text-sky-400 transition-colors" />
            </a>
